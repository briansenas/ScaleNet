...
@registry.ROI_BOX_FEATURE_EXTRACTORS.register("FPN2MLPFeatureExtractorRui")
class FPN2MLPFeatureExtractorRui(nn.Module):
    """
    Heads for FPN for classification
    """

    def __init__(self, cfg, in_channels):
        super(FPN2MLPFeatureExtractorRui, self).__init__()
